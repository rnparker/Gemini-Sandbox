...
Requirements:
1. Research and incorporate the LATEST market context for Canadian and US bond markets as of {current_date}. 
...
6. Keep the tone professional, insightful, and concise.
